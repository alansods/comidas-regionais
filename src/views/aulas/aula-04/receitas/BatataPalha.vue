    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>Batata inglesa - 1kg</li>
          <li>Gordura vegetal para fritura - 1kg</li>
          <li>Água - 2kg</li>
          <li>Farinha de trigo - 20g</li>
          <li>Amido de milho - 20g</li>
          <li>Sal - Q.B</li>
        </ul>
      </div>
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <p>
          Prepare a solução com água, sal, açúcar, amido de milho e farinha de trigo e reserve. Lave bem as batatas e descasque em seguida. Rale no ralo grosso e coloque para descansar na solução. Esse método serve para tirar uma parte do amido da batata e também conferir crocância depois de frita. Passados 10 minutos, retire as batatas da solução, escorrendo e secando com papel toalha e frite na gordura a uma temperatura de 160 ºC. Estará pronta quando começar a dourar. 
        </p>

        <p>
          O "Q.B" que aparece na receita, significa “Quanto baste”, ou seja, no preparo, você decide quanto quer colocar de sal.
        </p>
      </div>
