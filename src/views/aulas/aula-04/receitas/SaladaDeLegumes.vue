  ...
  <div id="aula-01">
    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <p>
          Lave os legumes e descasque todos. Corte em cubinhos e leve para cozinhar com sal até a textura dos legumes ficar "ao dente". Retire do cozimento e coloque em uma travessa. Misture o suco de limão com a maionese e coloque por cima dos legumes. Sirva em seguida.
        </p>
...
<script>
export default {
  title: "Aula 03 - Receitas: Salada de Legumes",
  components: {},
  data() {
    return {};
  },
