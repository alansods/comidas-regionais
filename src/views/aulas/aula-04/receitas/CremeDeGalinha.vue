    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>Páprica defumada - 3g</li>
          <li>Sal - Q.B</li>
          <li>Coloral - 20g</li>
          <li>Cheiro verde - 1/2 maço</li>
          <li>Leite líquido - 500g</li>
          <li>Milho verde - 170g</li>
          <li>Ervilha - 170g</li>
          <li>Creme de leite - 100g</li>
          <li>Caldo do cozimento do frango - 500g</li>
          <li>Farinha de trigo sem fermento - 150g</li>
        </ul>
      </div>
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <p>
          Cozinhe o frango com todos os temperos, desfie e reserve. Passe o caldo do frango no liquidificador, coe e reserve. Misture a farinha com o leite e acrescente o caldo. Misture bem. Leve ao fogo e deixe ferver bem. Após fervura, retire do fogo e reserve. Em outra panela, refogue o frango desfiado com os temperos, junte o creme cozido e deixe ferver por mais 10 minutos. Acrescente o milho, a ervilha e o creme de leite para finalizar.
        </p>
...
<script>
export default {
  title: "Aula 03 - Receitas: Creme de Galinha",
  components: {},
  data() {
    return {};
  },
  methods: {
    ended() {
      this.$store.commit("COMPLETAR_RECEITA_11");
    },
  },
  created() {
