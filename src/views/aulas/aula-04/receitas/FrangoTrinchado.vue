    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          ...
          <li>Alho in natura - 50g</li>
          <li>Pimenta do reino - Q.B</li>
          <li>Sal - Q.B</li>
          <li>Óleo de soja ou Azeite - 200</li>
          <li>Limão - 50g</li>
          <li>Açafrão - Q.B</li>
          <li>Cebola - 100g</li>
        </ul>
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <p>
          Corte o frango em tiras pequenas, coloque o suco dos limões no frango
          e misture bem. Deixe descansar por 20 minutos. Lave o frango e, em
          seguida, tempere com o alho, pimenta, sal e o açafrão. Deixe descansar
          por uma hora. Coloque óleo em uma panela e deixe aquecer bem. Em
          seguida, coloque os pedaços do frango e deixe fritar, até ficarem
          dourados. Retire o frango da frigideira e coloque em uma travessa.
          Pronto! Agora, é só servir com acompanhamento!
        </p>

        <p>
          OBS: O "Q.B" que aparece na receita, significa “Quanto baste”, ou
          seja, no preparo, você decide quanto quer colocar de sal.
        </p>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Frango Trinchado",
  components: {},
  data() {
    return {};
  },
  methods: {
    ended() {
      this.$store.commit("COMPLETAR_RECEITA_10");
    },
  },
  created() {
