    ...
    >
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <ul class="lista-check mb-0">
          <li>Linguiça calabresa - 1kg</li>
          <li>Cebola - 150g</li>
          <li>Manteiga da terra - 100g</li>
        </ul>
      </div>
      ...
      <div class="bg-white p-8 rounded-lg shadow my-5">
        ...
        <p>
          Cozinhe as linguiças calabresas em água fervente. Corte em formato de
          cubinhos ou rodelas e reserve. Corte a cebola em “julienne” e leve
          para fritar com manteiga da terra. Coloque a calabresa e frite, até a
          calabresa começar a ficar dourada. Em seguida, é só servir.
        </p>
      </div>
...
<script>
export default {
  title: "Aula 03 - Receitas: Linguiça acebolada",
  components: {},
  data() {
    return {};
  },
  methods: {
    ended() {
      this.$store.commit("COMPLETAR_RECEITA_9");
    },
  },
  created() {
